...
public class Hotkeys
{
    ...
    private static final KeybindSettings ANY = KeybindSettings.create(KeybindSettings.Context.ANY, KeyAction.PRESS, false, false, false, true);
    ...
    public static final ConfigHotkey MASS_CRAFT_TOGGLE          = new ConfigHotkey("massCraftToggle",   "", ANY, "Toggle mass craft");
